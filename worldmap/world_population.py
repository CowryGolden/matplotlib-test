...
# 使用Pygal自定义样式，使用LightColorizedStyle作为基色
...
wm.add('2016: 0-10M', cc_pops_1)
wm.add('2016: 10M-1BN', cc_pops_2)
wm.add('2016: >1BN', cc_pops_3)
# 渲染地图成svg文件
wm.render_to_file('images/worldmap_world_population_2016.svg')
